...
You can download the executable file `Protractor.exe` on the [release page](https://github.com/ap13ski/Protractor/releases/tag/v1.2). 
...
- [x] Use the switch in the lower-left corner or press **[L]** to toggle **Lock Delta Angle** mode.
